class Prefecture < ActiveHash::Base
  self.data = [
      ...
      {id: 4, name: '宮城県', theme1: 'グルメ', theme5: 'その他', info: "テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト", image: "miyagi.jpg", link:"https://www.pref.miyagi.jp/site/kankou/"},
      {id: 5, name: '秋田県', theme2: '温泉', theme5: 'その他', info: "テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト", image: "akita.jpg", link:"https://akita-fun.jp/"},
      {id: 6, name: '山形県', theme2: '温泉', theme5: 'その他', info: "テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト", image: "yamagata.jpg", link:"https://yamagatakanko.com/"},
      ...
      {id: 18, name: '福井県', theme5: 'その他', info: "テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト", image: "fukui.jpg", link:"fukui.com"},
